...
public class GiteaApiService {
    ...
    private Object sendRequest(HttpEntity<?> httpEntity, String path, HttpMethod httpMethod, ParameterizedTypeReference<?> parameterizedTypeReference, LogMessage onNull, LogMessage onException) throws GiteaApiException {
    ...
    private void sendRequest(HttpEntity<?> httpEntity, String path, HttpMethod httpMethod, LogMessage onException) throws GiteaApiException {
        final String fullPath = giteaBaseUrl + path;
        try {
